        ...
        <SectionAnimator>
            <div className="container mx-auto px-6 mb-16">
                 <div className="aspect-video rounded-2xl overflow-hidden shadow-2xl shadow-accent-purple/10">
                    <img class="w-full h-full object-cover" alt={project.images.hero.alt} src="https://horizons-cdn.hostinger.com/2ec1b63c-413d-4920-8651-9e095efacb1d/gemini_generated_image_n6u5epn6u5epn6u5-5ABrF.png" />
                 </div>
            </div>
        </SectionAnimator>
                ...
                <div className="grid grid-cols-1 gap-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="aspect-square rounded-2xl overflow-hidden">
                           <img class="w-full h-full object-cover" alt={project.images.gallery[1].alt} src="https://horizons-cdn.hostinger.com/2ec1b63c-413d-4920-8651-9e095efacb1d/gemini_generated_image_mxgp1bmxgp1bmxgp-IDwMQ.png" />
                        </div>
                        <div className="aspect-square rounded-2xl overflow-hidden">
                            <img class="w-full h-full object-cover" alt={project.images.gallery[2].alt} src="https://horizons-cdn.hostinger.com/2ec1b63c-413d-4920-8651-9e095efacb1d/gemini_generated_image_mxgp1bmxgp1bmxgp-1-RqwfI.png" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <SectionAnimator>
            <div className="container mx-auto px-6 mb-16">
                <div className="aspect-video rounded-2xl overflow-hidden">
                    <img class="w-full h-full object-cover" alt={project.images.gallery2[0].alt} src="https://horizons-cdn.hostinger.com/2ec1b63c-413d-4920-8651-9e095efacb1d/professional-exchange-BmQpX.png" />
                </div>
            </div>
        </SectionAnimator>
