      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-left md:text-center">
          ...
          >
            ...
            <span className="text-sm text-[#c5b8ff] uppercase">Membership-Based Creative Hub</span>
          </motion.div>
          ...
          >
            Welcome to
            <span className="block text-accent-purple">Cle`Agency</span>
          </motion.h1>
          ...
          >
            A membership-based hub for entrepreneurs and innovators mastering the business of creativity and generating real-world wealth
          </motion.p>
